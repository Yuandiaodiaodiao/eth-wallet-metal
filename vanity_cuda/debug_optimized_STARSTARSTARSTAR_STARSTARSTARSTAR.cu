...
#define CHECK_HEAD_PATTERN(addr) (((addr[0] >> 4) == (addr[0] & 0xF)) && ((addr[0] >> 4) == (addr[1] >> 4)) && ((addr[0] >> 4) == (addr[1] & 0xF)) && ((addr[0] >> 4) == (addr[18] >> 4)) && ((addr[0] >> 4) == (addr[18] & 0xF)) && ((addr[0] >> 4) == (addr[19] >> 4)) && ((addr[0] >> 4) == (addr[19] & 0xF)))
